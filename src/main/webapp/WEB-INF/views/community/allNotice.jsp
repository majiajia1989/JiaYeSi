	...
	<div data-role="page">
		<div data-role="content">
			<div data-role="navbar" data-iconpos="left">
				<ul>
					...
					<li><a href="${ctx}/community/allNotice/1" data-role="button" data-icon="allEmail"  class="ui-btn-active ui-state-persist">全部消息</a></li>
				</ul>
			</div>
		...
		<div data-role="footer" data-position="fixed" data-tap-toggle="false">
			...
			<c:if test="${nextPage > page}">
				<a href="${ctx}/community/allNotice/${nextPage}"
