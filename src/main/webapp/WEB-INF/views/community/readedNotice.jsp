	...
	<div data-role="page">
			...
			<div data-role="navbar" data-iconpos="left">
				<ul>
					<li><a href="${ctx}/community/unreadNotice/1"
						data-role="button" data-icon="mail">未读消息</a></li>
					<li><a href="${ctx}/community/readedNotice/1"
						data-role="button" data-icon="readEmail"  class="ui-btn-active ui-state-persist">已读消息</a></li>
			...
			<ul data-role="listview" data-count-theme="b" data-inset="true"
				...
				<c:forEach items="${notices}" var="noticeInfo">
					<li><a href="${ctx}/community/noticeDetail/${noticeInfo.id}">
							<h2 style="margin-right: 4em;margin-top:1em;">${noticeInfo.notice.title}</h2>
							<p class="ui-li-aside">
		...
		<div data-role="footer" data-position="fixed" data-tap-toggle="false">
			<a href="#" onclick="history.back();"
				class="ui-btn ui-mini ui-corner-all ui-btn-icon-left ui-icon-back" style="margin: 0.2em; float:left;">后&nbsp;退</a>

			<c:if test="${nextPage > page}">
				<a href="${ctx}/community/readedNotice/${nextPage}"
					class="pull-right ui-btn ui-icon-more ui-btn-icon-left" style="margin: 0.2em; float: right;">更多</a>
			</c:if>
			<c:if test="${nextPage <= page}">
				<a href="javascript:App.toast();"
					class="pull-right ui-btn ui-icon-more ui-btn-icon-left">更多</a>
			</c:if>
		</div>
